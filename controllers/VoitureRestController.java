...
import com.locationVoiture.services.VoitureService;
...
public class VoitureRestController {
	...
	public ResponseEntity<List<Voiture>> getAllVoitures(){
	  ...
	  updateVoiture(@PathVariable("id") long id, @RequestBody Voiture voiture) {
	    ...
	    if (_voiture != null) {
	    	_voiture.setMatricule(voiture.getMatricule());
		    _voiture.setCouleur(voiture.getCouleur());
		      voitureService.saveVoiture(_voiture);	
